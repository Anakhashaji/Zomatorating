...
app = Flask(__name__)
model = pickle.load(open("Model_Selection/model.pkl", "rb"))

#Label encoding 
cuisines_encoder = pickle.load(open("EDA And Feature Engineering/cuisines_encoder.pkl", "rb"))
listed_in_type_encoder = pickle.load(open("EDA And Feature Engineering/listed_in_type_encoder.pkl", "rb"))
location_encoder = pickle.load(open("EDA And Feature Engineering/location_encoder.pkl", "rb"))
name_encoder = pickle.load(open("EDA And Feature Engineering/name_encoder.pkl", "rb"))
rest_type_encoder = pickle.load(open("EDA And Feature Engineering/type_encoder.pkl", "rb"))
...
## normalizer
normalizer = pickle.load(open("Model_Selection/normalizer.pkl", "rb"))
